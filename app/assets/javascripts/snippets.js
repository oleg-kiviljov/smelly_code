var SnippetsController = Paloma.controller('Snippets');

SnippetsController.prototype.index = function(){
 $("#apply-filters").click(apply_filters);
};

SnippetsController.prototype.new = function(){
 initialize_example_snippet();
};

SnippetsController.prototype.edit = function(){
  initialize_example_snippet();
  load_result_snippet();
};

function initialize_example_snippet(){
